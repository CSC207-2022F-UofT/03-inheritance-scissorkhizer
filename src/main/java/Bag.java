...
public abstract class Bag {
    ...
    public String popItem() {
        if (this.numberOfContents > 0) {
            this.numberOfContents -= 1;
            String to_return = this.contents[this.numberOfContents];
    ...
    public void increaseCapacity(int n) {
        ...
        String[] biggerContents = new String[this.capacity + n];
        if (this.capacity >= 0) System.arraycopy(this.contents, 0, biggerContents, 0, this.capacity);
